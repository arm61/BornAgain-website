...
def get_sample():
    ...
    par_distr_1 = ba.ParameterDistribution("/Particle/Cylinder/Radius", distr_1, 150,
                                           3.0, ba.RealLimits.nonnegative())
    particleDistribution_1 = ba.ParticleDistribution(particle_1, par_distr_1)
    distr_2 = ba.DistributionGaussian(10.0*nm, 0.2*nm)
    par_distr_2 = ba.ParameterDistribution("/Particle/Cylinder/Radius", distr_2, 150,
                                           3.0, ba.RealLimits.nonnegative())
