...
This example demonstrates how to perform a simulation of a grating using very long boxes and a 1D lattice. [Interference of a 1D lattice]({{% ref-example "interference-functions/interference-1d-lattice" %}}) may provide useful background information.
...
{{< highlightfile file="/static/files/python/simulation/ex03_InterferenceFunctions/GratingMC.py" language="python" >}}
